...
},{}],"models/Furnitures.js":[function(require,module,exports) {
"use strict";
...
var Furnitures = /*#__PURE__*/function () {
  function Furnitures() {
    (0, _classCallCheck2.default)(this, Furnitures);
    this.items = [];
    this.searchString = '';
    this.searchResults = [];
  }

  (0, _createClass2.default)(Furnitures, [{
    key: "getFurnituresData",
    value: function () {
      var _getFurnituresData = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
        var response, data;
      ...
      function getFurnituresData() {
        return _getFurnituresData.apply(this, arguments);
      }

      return getFurnituresData;
    }()
  }, {
    key: "filterFurnitures",
    value: function filterFurnitures(query) {
      var _this = this;

      this.searchString = query.toLowerCase();
      this.searchResults = this.items.filter(function (item) {
        return item.name.includes(_this.searchString) || item.type.includes(_this.searchString);
      });
    }
  }]);
  return Furnitures;
...
},{"./arrayWithoutHoles":"../node_modules/@babel/runtime/helpers/arrayWithoutHoles.js","./iterableToArray":"../node_modules/@babel/runtime/helpers/iterableToArray.js","./unsupportedIterableToArray":"../node_modules/@babel/runtime/helpers/unsupportedIterableToArray.js","./nonIterableSpread":"../node_modules/@babel/runtime/helpers/nonIterableSpread.js"}],"views/furniture.js":[function(require,module,exports) {
"use strict";
...
var renderFurnitures = function renderFurnitures(furnituresList, currentPage, itemsPerPage) {
  var containerEl = document.querySelector('.furnitures-grid');
  var template;

  if (furnituresList.length) {
    template = furnituresList.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(function (furniture) {
      return "\n        <a class=\"furniture-tile\" href=\"#".concat(furniture.id, "\">\n            <div class=\"image-container\">\n                <img src=\"/assets/images/").concat(furniture.image, "\" alt=\"image\">\n                <div class=\"stripe\"></div>\n            </div>\n            <div class=\"name\"><strong>").concat(furniture.name, "</strong></div>\n            <div class=\"type-price\">\n                <span class=\"type\"><strong>").concat(furniture.type, "</strong></span>\n                <span class=\"price\">$").concat(furniture.price, "</span>\n            </div>\n            <div class=\"ratings-cart\">\n                <div class=\"ratings\">").concat((0, _toConsumableArray2.default)(Array(5).keys()).map(function (el) {
        return el + 1 <= furniture.rating ? '<i class="fas fa-star"></i>' : '<i class="far fa-star"></i>';
...
var renderPagination = function renderPagination(totalPages, currentPage) {
  var paginationContainer = document.querySelector('.pagination');

  if (totalPages) {
    var template = (0, _toConsumableArray2.default)(Array(totalPages).keys()).map(function (el) {
      return "\n            <span class=\"page-number\" data-goto=\"".concat(el + 1, "\">\n                <input type=\"radio\" id=\"").concat(el + 1, "\" name=\"page\" value=\"").concat(el + 1, "\" class=\"page-radio-button\" ").concat(el + 1 === currentPage ? 'checked' : '', ">\n                <label for=\"").concat(el + 1, "\" class=\"page-label\"><strong>").concat(el + 1, "</strong></label>\n            </span>\n        ");
    }).join('');
...
var renderFurnituresListPage = function renderFurnituresListPage() {
...
var renderFurniturePage = function renderFurniturePage(furnitureData) {
...
var _Furnitures = _interopRequireDefault(require("./models/Furnitures"));

var _furniture = _interopRequireDefault(require("./views/furniture"));
  ...
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            state.furnitures = new _Furnitures.default();
            _context.next = 3;
            return state.furnitures.getFurnituresData();
...
['hashchange', 'load'].forEach(function (event) {
  return window.addEventListener(event, routeHandler);
});
/** HANDLE FURNITURE SEARCH */

var inputSearchHandler = function inputSearchHandler(event) {
  ...
  _furniture.default.renderFurnitures(state.furnitures.searchResults, state.currentPage, state.itemsPerPage);

  _furniture.default.renderPagination(state.totalPages, state.currentPage);
};

document.querySelector('.search-part input').addEventListener('input', _utils.default.debounce(inputSearchHandler, 500));
/** HANDLE PAGINATION */

var paginationHandler = function paginationHandler(event) {
  ...
  if (event.target.closest('.page-number')) {
    var gotoPage = event.target.closest('.page-number').dataset.goto;
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","./models/Furnitures":"models/Furnitures.js","./views/furniture":"views/furniture.js","./utils":"utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
